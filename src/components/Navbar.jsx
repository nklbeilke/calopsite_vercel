      ...
      <div className="flex items-center px-8 py-5 gap-4">
        ...
        <nav className="pb-3">
          <div className="max-w-[680px] mx-auto flex justify-between items-center">
            ...
            <Link to="/categoria/alimentacao" className="font-semibold text-[#7A5C34] hover:text-orange-600 transition">
              Alimentação
            </Link>

            <Link to="/categoria/habitat" className="font-semibold text-[#7A5C34] hover:text-orange-600 transition">
              Habitat
            </Link>

            <Link to="/categoria/enriquecimento" className="font-semibold text-[#7A5C34] hover:text-orange-600 transition">
              Enriquecimento
            </Link>
